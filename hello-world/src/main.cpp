// Refactored Feather ESP32 PN532 Sketch with No Lambdas
#include <SPI.h>
#include <PN532_SPI.h>
#include <PN532.h>
...
const byte trainCommandTextArray[NUM_TRAIN_COMMANDS][TRAIN_COMMAND_STR_LENGTH] = {
...
void sendDataCentral(int data, unsigned long delayMs = 0);
...
void sendDataCentral(int data, unsigned long delayMs) {
  if (delayMs == 0) {
